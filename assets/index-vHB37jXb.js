 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _s=Vk;function aE(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Od,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw gr.create("bad-app-name",{appName:String(i)});if(n||(n=Zw()),!n)throw gr.create("no-options");const s=tu.get(i);if(s){if(is(n,s.options)&&is(r,s.config))return s;throw gr.create("duplicate-app",{appName:i})}const o=new KP(i);for(const u of Dd.values())o.addComponent(u);const l=new jk(n,r,o);return tu.set(i,l),l}function sp(t=Od){const e=tu.get(t);if(!e&&t===Od&&Zw())return aE();if(!e)throw gr.create("no-app",{appName:t});return e}function jt(t,e,n){var r;let i=(r=Mk[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const l=[`Unable to register library "${i}" with version "${e}":`];s&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Vn.warn(l.join(" "));return}fn(new Yt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qk(t){fn(new Yt("platform-logger",e=>new lk(e),"PRIVATE")),fn(new Yt("heartbeat",e=>new Wk(e),"PRIVATE")),jt(xd,Vy,t),jt(xd,Vy,"esm2017"),jt("fire-js","")}Qk("");var By=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var Qr,cE;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,y){function v(){}v.prototype=y.prototype,I.D=y.prototype,I.prototype=new v,I.prototype.constructor=I,I.C=function(R,k,x){for(var A=Array(arguments.length-2),se=2;se<arguments.length;se++)A[se-2]=arguments[se];return y.prototype[k].apply(R,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(I,y,v){v||(v=0);var R=Array(16);if(typeof y=="string")for(var k=0;16>k;++k)R[k]=y.charCodeAt(v++)|y.charCodeAt(v++)<<8|y.charCodeAt(v++)<<16|y.charCodeAt(v++)<<24;else for(k=0;16>k;++k)R[k]=y[v++]|y[v++]<<8|y[v++]<<16|y[v++]<<24;y=I.g[0],v=I.g[1],k=I.g[2];var x=I.g[3],A=y+(x^v&(k^x))+R[0]+3614090360&4294967295;y=v+(A<<7&4294967295|A>>>25),A=x+(k^y&(v^k))+R[1]+3905402710&4294967295,x=y+(A<<12&4294967295|A>>>20),A=k+(v^x&(y^v))+R[2]+606105819&4294967295,k=x+(A<<17&4294967295|A>>>15),A=v+(y^k&(x^y))+R[3]+3250441966&4294967295,v=k+(A<<22&4294967295|A>>>10),A=y+(x^v&(k^x))+R[4]+4118548399&4294967295,y=v+(A<<7&4294967295|A>>>25),A=x+(k^y&(v^k))+R[5]+1200080426&4294967295,x=y+(A<<12&4294967295|A>>>20),A=k+(v^x&(y^v))+R[6]+2821735955&4294967295,k=x+(A<<17&4294967295|A>>>15),A=v+(y^k&(x^y))+R[7]+4249261313&4294967295,v=k+(A<<22&4294967295|A>>>10),A=y+(x^v&(k^x))+R[8]+1770035416&4294967295,y=v+(A<<7&4294967295|A>>>25),A=x+(k^y&(v^k))+R[9]+2336552879&4294967295,x=y+(A<<12&4294967295|A>>>20),A=k+(v^x&(y^v))+R[10]+4294925233&4294967295,k=x+(A<<17&4294967295|A>>>15),A=v+(y^k&(x^y))+R[11]+2304563134&4294967295,v=k+(A<<22&4294967295|A>>>10),A=y+(x^v&(k^x))+R[12]+1804603682&4294967295,y=v+(A<<7&4294967295|A>>>25),A=x+(k^y&(v^k))+R[13]+4254626195&4294967295,x=y+(A<<12&4294967295|A>>>20),A=k+(v^x&(y^v))+R[14]+2792965006&4294967295,k=x+(A<<17&4294967295|A>>>15),A=v+(y^k&(x^y))+R[15]+1236535329&4294967295,v=k+(A<<22&4294967295|A>>>10),A=y+(k^x&(v^k))+R[1]+4129170786&4294967295,y=v+(A<<5&4294967295|A>>>27),A=x+(v^k&(y^v))+R[6]+3225465664&4294967295,x=y+(A<<9&4294967295|A>>>23),A=k+(y^v&(x^y))+R[11]+643717713&4294967295,k=x+(A<<14&4294967295|A>>>18),A=v+(x^y&(k^x))+R[0]+3921069994&4294967295,v=k+(A<<20&4294967295|A>>>12),A=y+(k^x&(v^k))+R[5]+3593408605&4294967295,y=v+(A<<5&4294967295|A>>>27),A=x+(v^k&(y^v))+R[10]+38016083&4294967295,x=y+(A<<9&4294967295|A>>>23),A=k+(y^v&(x^y))+R[15]+3634488961&4294967295,k=x+(A<<14&4294967295|A>>>18),A=v+(x^y&(k^x))+R[4]+3889429448&4294967295,v=k+(A<<20&4294967295|A>>>12),A=y+(k^x&(v^k))+R[9]+568446438&4294967295,y=v+(A<<5&4294967295|A>>>27),A=x+(v^k&(y^v))+R[14]+3275163606&4294967295,x=y+(A<<9&4294967295|A>>>23),A=k+(y^v&(x^y))+R[3]+4107603335&4294967295,k=x+(A<<14&4294967295|A>>>18),A=v+(x^y&(k^x))+R[8]+1163531501&4294967295,v=k+(A<<20&4294967295|A>>>12),A=y+(k^x&(v^k))+R[13]+2850285829&4294967295,y=v+(A<<5&4294967295|A>>>27),A=x+(v^k&(y^v))+R[2]+4243563512&4294967295,x=y+(A<<9&4294967295|A>>>23),A=k+(y^v&(x^y))+R[7]+1735328473&4294967295,k=x+(A<<14&4294967295|A>>>18),A=v+(x^y&(k^x))+R[12]+2368359562&4294967295,v=k+(A<<20&4294967295|A>>>12),A=y+(v^k^x)+R[5]+4294588738&4294967295,y=v+(A<<4&4294967295|A>>>28),A=x+(y^v^k)+R[8]+2272392833&4294967295,x=y+(A<<11&4294967295|A>>>21),A=k+(x^y^v)+R[11]+1839030562&4294967295,k=x+(A<<16&4294967295|A>>>16),A=v+(k^x^y)+R[14]+4259657740&4294967295,v=k+(A<<23&4294967295|A>>>9),A=y+(v^k^x)+R[1]+2763975236&4294967295,y=v+(A<<4&4294967295|A>>>28),A=x+(y^v^k)+R[4]+1272893353&4294967295,x=y+(A<<11&4294967295|A>>>21),A=k+(x^y^v)+R[7]+4139469664&4294967295,k=x+(A<<16&4294967295|A>>>16),A=v+(k^x^y)+R[10]+3200236656&4294967295,v=k+(A<<23&4294967295|A>>>9),A=y+(v^k^x)+R[13]+681279174&4294967295,y=v+(A<<4&4294967295|A>>>28),A=x+(y^v^k)+R[0]+3936430074&4294967295,x=y+(A<<11&4294967295|A>>>21),A=k+(x^y^v)+R[3]+3572445317&4294967295,k=x+(A<<16&4294967295|A>>>16),A=v+(k^x^y)+R[6]+76029189&4294967295,v=k+(A<<23&4294967295|A>>>9),A=y+(v^k^x)+R[9]+3654602809&4294967295,y=v+(A<<4&4294967295|A>>>28),A=x+(y^v^k)+R[12]+3873151461&4294967295,x=y+(A<<11&4294967295|A>>>21),A=k+(x^y^v)+R[15]+530742520&4294967295,k=x+(A<<16&4294967295|A>>>16),A=v+(k^x^y)+R[2]+3299628645&4294967295,v=k+(A<<23&4294967295|A>>>9),A=y+(k^(v|~x))+R[0]+4096336452&4294967295,y=v+(A<<6&4294967295|A>>>26),A=x+(v^(y|~k))+R[7]+1126891415&4294967295,x=y+(A<<10&4294967295|A>>>22),A=k+(y^(x|~v))+R[14]+2878612391&4294967295,k=x+(A<<15&4294967295|A>>>17),A=v+(x^(k|~y))+R[5]+4237533241&4294967295,v=k+(A<<21&4294967295|A>>>11),A=y+(k^(v|~x))+R[12]+1700485571&4294967295,y=v+(A<<6&4294967295|A>>>26),A=x+(v^(y|~k))+R[3]+2399980690&4294967295,x=y+(A<<10&4294967295|A>>>22),A=k+(y^(x|~v))+R[10]+4293915773&4294967295,k=x+(A<<15&4294967295|A>>>17),A=v+(x^(k|~y))+R[1]+2240044497&4294967295,v=k+(A<<21&4294967295|A>>>11),A=y+(k^(v|~x))+R[8]+1873313359&4294967295,y=v+(A<<6&4294967295|A>>>26),A=x+(v^(y|~k))+R[15]+4264355552&4294967295,x=y+(A<<10&4294967295|A>>>22),A=k+(y^(x|~v))+R[6]+2734768916&4294967295,k=x+(A<<15&4294967295|A>>>17),A=v+(x^(k|~y))+R[13]+1309151649&4294967295,v=k+(A<<21&4294967295|A>>>11),A=y+(k^(v|~x))+R[4]+4149444226&4294967295,y=v+(A<<6&4294967295|A>>>26),A=x+(v^(y|~k))+R[11]+3174756917&4294967295,x=y+(A<<10&4294967295|A>>>22),A=k+(y^(x|~v))+R[2]+718787259&4294967295,k=x+(A<<15&4294967295|A>>>17),A=v+(x^(k|~y))+R[9]+3951481745&4294967295,I.g[0]=I.g[0]+y&4294967295,I.g[1]=I.g[1]+(k+(A<<21&4294967295|A>>>11))&4294967295,I.g[2]=I.g[2]+k&4294967295,I.g[3]=I.g[3]+x&4294967295}r.prototype.u=function(I,y){y===void 0&&(y=I.length);for(var v=y-this.blockSize,R=this.B,k=this.h,x=0;x<y;){if(k==0)for(;x<=v;)i(this,I,x),x+=this.blockSize;if(typeof I=="string"){for(;x<y;)if(R[k++]=I.charCodeAt(x++),k==this.blockSize){i(this,R),k=0;break}}else for(;x<y;)if(R[k++]=I[x++],k==this.blockSize){i(this,R),k=0;break}}this.h=k,this.o+=y},r.prototype.v=function(){var I=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);I[0]=128;for(var y=1;y<I.length-8;++y)I[y]=0;var v=8*this.o;for(y=I.length-8;y<I.length;++y)I[y]=v&255,v/=256;for(this.u(I),I=Array(16),y=v=0;4>y;++y)for(var R=0;32>R;R+=8)I[v++]=this.g[y]>>>R&255;return I};function s(I,y){var v=l;return Object.prototype.hasOwnProperty.call(v,I)?v[I]:v[I]=y(I)}function o(I,y){this.h=y;for(var v=[],R=!0,k=I.length-1;0<=k;k--){var x=I[k]|0;R&&x==y||(v[k]=x,R=!1)}this.g=v}var l={};function u(I){return-128<=I&&128>I?s(I,function(y){return new o([y|0],0>y?-1:0)}):new o([I|0],0>I?-1:0)}function c(I){if(isNaN(I)||!isFinite(I))return p;if(0>I)return P(c(-I));for(var y=[],v=1,R=0;I>=v;R++)y[R]=I/v|0,v*=4294967296;return new o(y,0)}function d(I,y){if(I.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(I.charAt(0)=="-")return P(d(I.substring(1),y));if(0<=I.indexOf("-"))throw Error('number format error: interior "-" character');for(var v=c(Math.pow(y,8)),R=p,k=0;k<I.length;k+=8){var x=Math.min(8,I.length-k),A=parseInt(I.substring(k,k+x),y);8>x?(x=c(Math.pow(y,x)),R=R.j(x).add(c(A))):(R=R.j(v),R=R.add(c(A)))}return R}var p=u(0),m=u(1),w=u(16777216);t=o.prototype,t.m=function(){if(C(this))return-P(this).m();for(var I=0,y=1,v=0;v<this.g.length;v++){var R=this.i(v);I+=(0<=R?R:4294967296+R)*y,y*=4294967296}return I},t.toString=function(I){if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(E(this))return"0";if(C(this))return"-"+P(this).toString(I);for(var y=c(Math.pow(I,6)),v=this,R="";;){var k=D(v,y).g;v=T(v,k.j(y));var x=((0<v.g.length?v.g[0]:v.h)>>>0).toString(I);if(v=k,E(v))return x+R;for(;6>x.length;)x="0"+x;R=x+R}},t.i=function(I){return 0>I?0:I<this.g.length?this.g[I]:this.h};function E(I){if(I.h!=0)return!1;for(var y=0;y<I.g.length;y++)if(I.g[y]!=0)return!1;return!0}function C(I){return I.h==-1}t.l=function(I){return I=T(this,I),C(I)?-1:E(I)?0:1};function P(I){for(var y=I.g.length,v=[],R=0;R<y;R++)v[R]=~I.g[R];return new o(v,~I.h).add(m)}t.abs=function(){return C(this)?P(this):this},t.add=function(I){for(var y=Math.max(this.g.length,I.g.length),v=[],R=0,k=0;k<=y;k++){var x=R+(this.i(k)&65535)+(I.i(k)&65535),A=(x>>>16)+(this.i(k)>>>16)+(I.i(k)>>>16);R=A>>>16,x&=65535,A&=65535,v[k]=A<<16|x}return new o(v,v[v.length-1]&-2147483648?-1:0)};function T(I,y){return I.add(P(y))}t.j=function(I){if(E(this)||E(I))return p;if(C(this))return C(I)?P(this).j(P(I)):P(P(this).j(I));if(C(I))return P(this.j(P(I)));if(0>this.l(w)&&0>I.l(w))return c(this.m()*I.m());for(var y=this.g.length+I.g.length,v=[],R=0;R<2*y;R++)v[R]=0;for(R=0;R<this.g.length;R++)for(var k=0;k<I.g.length;k++){var x=this.i(R)>>>16,A=this.i(R)&65535,se=I.i(k)>>>16,gn=I.i(k)&65535;v[2*R+2*k]+=A*gn,_(v,2*R+2*k),v[2*R+2*k+1]+=x*gn,_(v,2*R+2*k+1),v[2*R+2*k+1]+=A*se,_(v,2*R+2*k+1),v[2*R+2*k+2]+=x*se,_(v,2*R+2*k+2)}for(R=0;R<y;R++)v[R]=v[2*R+1]<<16|v[2*R];for(R=y;R<2*y;R++)v[R]=0;return new o(v,0)};function _(I,y){for(;(I[y]&65535)!=I[y];)I[y+1]+=I[y]>>>16,I[y]&=65535,y++}function S(I,y){this.g=I,this.h=y}function D(I,y){if(E(y))throw Error("division by zero");if(E(I))return new S(p,p);if(C(I))return y=D(P(I),y),new S(P(y.g),P(y.h));if(C(y))return y=D(I,P(y)),new S(P(y.g),y.h);if(30<I.g.length){if(C(I)||C(y))throw Error("slowDivide_ only works with positive integers.");for(var v=m,R=y;0>=R.l(I);)v=M(v),R=M(R);var k=j(v,1),x=j(R,1);for(R=j(R,2),v=j(v,2);!E(R);){var A=x.add(R);0>=A.l(I)&&(k=k.add(v),x=A),R=j(R,1),v=j(v,1)}return y=T(I,k.j(y)),new S(k,y)}for(k=p;0<=I.l(y);){for(v=Math.max(1,Math.floor(I.m()/y.m())),R=Math.ceil(Math.log(v)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),x=c(v),A=x.j(y);C(A)||0<A.l(I);)v-=R,x=c(v),A=x.j(y);E(x)&&(x=m),k=k.add(x),I=T(I,A)}return new S(k,I)}t.A=function(I){return D(this,I).h},t.and=function(I){for(var y=Math.max(this.g.length,I.g.length),v=[],R=0;R<y;R++)v[R]=this.i(R)&I.i(R);return new o(v,this.h&I.h)},t.or=function(I){for(var y=Math.max(this.g.length,I.g.length),v=[],R=0;R<y;R++)v[R]=this.i(R)|I.i(R);return new o(v,this.h|I.h)},t.xor=function(I){for(var y=Math.max(this.g.length,I.g.length),v=[],R=0;R<y;R++)v[R]=this.i(R)^I.i(R);return new o(v,this.h^I.h)};function M(I){for(var y=I.g.length+1,v=[],R=0;R<y;R++)v[R]=I.i(R)<<1|I.i(R-1)>>>31;return new o(v,I.h)}function j(I,y){var v=y>>5;y%=32;for(var R=I.g.length-v,k=[],x=0;x<R;x++)k[x]=0<y?I.i(x+v)>>>y|I.i(x+v+1)<<32-y:I.i(x+v);return new o(k,I.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,cE=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=d,Qr=o}).apply(typeof By<"u"?By:typeof self<"u"?self:typeof window<"u"?window:{});var Qa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uv={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0};class mt{static withCacheSize(e){return new mt(e,mt.DEFAULT_COLLECTION_PERCENTILE,mt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(e,n,r){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=n,this.maximumSequenceNumbersToCollect=r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kp{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new kp(this.firestore,e,this._query)}}class xt{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ho(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new xt(this.firestore,e,this._key)}}class Ho extends kp{constructor(e,n,r){super(e,n,hp(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new xt(this.firestore,null,new K(e))}withConverter(e){return new Ho(this.firestore,e,this._path)}}function Np(t,e,...n){if(t=ze(t),arguments.length===1&&(e=yE.newId()),qO("doc","path",e),t instanceof Pp){const r=Ce.fromString(e,...n);return Tv(r),new xt(t,null,new K(r))}{if(!(t instanceof xt||t instanceof Ho))throw new W(U.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Ce.fromString(e,...n));return Tv(r),new xt(t.firestore,t instanceof Ho?t.converter:null,new K(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vL=5*60,_L=eE("authIdTokenMaxAge")||vL;let $v=null;const wL=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>_L)return;const i=n==null?void 0:n.token;$v!==i&&($v=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function Go(t=sp()){const e=fi(t,"auth");if(e.isInitialized())return e.getImmediate();const n=$D(t,{popupRedirectResolver:pL,persistence:[Rb,fb,sI]}),r=eE("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const o=wL(s.toString());lb(n,o,()=>o(n.currentUser)),ab(n,l=>o(l))}}const i=Xw("auth");return i&&HD(n,`http://${i}`),n}function EL(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}LD({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const s=hn("internal-error");s.customData=i,n(s)},r.type="text/javascript",r.charset="UTF-8",EL().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});yL("Browser");const Rs=()=>{const t=ta();return N.jsxs("div",{className:"homebar",children:[N.jsxs(ct,{to:"/",className:`homebar-icon ${t.pathname==="/"?"active":""}`,children:[N.jsx("span",{children:"🏠"}),"Home"]}),N.jsxs(ct,{to:"/search",className:`homebar-icon ${t.pathname==="/search"?"active":""}`,children:[N.jsx("span",{children:"🔍"}),"Search"]}),N.jsxs(ct,{to:"/profile",className:`homebar-icon ${t.pathname==="/profile"?"active":""}`,children:[N.jsx("span",{children:"👤"}),"Profile"]})]})},Ti="https://api.themoviedb.org/3",Ii="a0ac84614536cd4679d457482617fd23",TL=()=>{const[t,e]=V.useState([]),[n,r]=V.useState([]),[i,s]=V.useState([]),[o,l]=V.useState([]),[u,c]=V.useState([]),[d,p]=V.useState(0),[m,w]=V.useState(!0),[E,C]=V.useState(null),[P,T]=V.useState(!1),[_,S]=V.useState(""),[D,M]=V.useState(null);V.useEffect(()=>{const v=Go(),R=ub(v,k=>{M(k)});return()=>R()},[]),V.useEffect(()=>{window.scrollTo(0,0);const v=async()=>{try{const se=await ue.get(`${Ti}/movie/popular`,{params:{api_key:Ii,language:"en-US",page:1}});e(se.data.results),w(!1)}catch(se){console.error(se),C("Failed to load movies"),w(!1)}},R=async()=>{try{const se=await ue.get(`${Ti}/trending/movie/week`,{params:{api_key:Ii,language:"en-US"}});r(se.data.results)}catch(se){console.error(se),C("Failed to load trending movies")}},k=async()=>{try{const se=await ue.get(`${Ti}/movie/popular`,{params:{api_key:Ii,language:"en-US",page:2}});s(se.data.results)}catch(se){console.error(se),C("Failed to load popular movies")}},x=async()=>{try{const se=await ue.get(`${Ti}/movie/top_rated`,{params:{api_key:Ii,language:"en-US",page:1}});l(se.data.results)}catch(se){console.error(se),C("Failed to load top-rated movies")}},A=async()=>{try{const se=await ue.get(`${Ti}/movie/upcoming`,{params:{api_key:Ii,language:"en-US",page:1}});c(se.data.results)}catch(se){console.error(se),C("Failed to load upcoming movies")}};v(),R(),k(),x(),A()},[]),V.useEffect(()=>{let v;const R=()=>{if(t.length>0){const k=Math.floor(Math.random()*t.length);p(k)}};return t.length>0&&(R(),v=setInterval(R,1e4)),()=>{v&&clearInterval(v)}},[t]);const j=async v=>{if(!D){console.log("User is not authenticated");return}const R=nc(),k=Np(R,"users",D.uid);if(!(await Vp(k)).exists())try{await CT(k,{name:D.displayName,email:D.email,movieList:[]}),console.log("User document created")}catch(A){console.error("Error creating user document: ",A);return}try{await PT(k,{movieList:NT({id:v.id,title:v.title,poster_path:v.poster_path,release_date:v.release_date,imdb_rating:v.vote_average,overview:v.overview})}),console.log("Movie added to list")}catch(A){console.error("Error adding movie to list: ",A)}},I=async v=>{try{const k=(await ue.get(`${Ti}/movie/${v}/videos`,{params:{api_key:Ii,language:"en-US"}})).data.results.find(x=>x.type==="Trailer");k&&(S(k.key),T(!0))}catch(R){console.error(R),C("Failed to load trailer")}},y=()=>{T(!P),S("")};return m?N.jsx("p",{children:"Loading movies..."}):E?N.jsx("p",{children:E}):N.jsxs("div",{className:"container",children:[N.jsx("div",{className:"card",children:t.length>0&&N.jsxs(N.Fragment,{children:[N.jsx(ct,{to:`/movie/${t[d].id}`,children:N.jsx("img",{src:`https://image.tmdb.org/t/p/w300${t[d].poster_path}`,alt:t[d].title,className:"image"})}),N.jsxs("div",{className:"overlay-buttons",children:[N.jsx("button",{className:"poster-button",onClick:()=>I(t[d].id),children:"Watch Trailer"}),N.jsx("button",{className:"poster-button",onClick:()=>j(t[d]),children:"Add to List"})]})]})}),P&&N.jsx("div",{className:"trailer-modal",onClick:y,children:N.jsxs("div",{className:"modal-content",onClick:v=>v.stopPropagation(),children:[N.jsx("button",{className:"close-btn",onClick:y,children:"X"}),_&&N.jsx("iframe",{width:"100%",height:"400px",src:`https://www.youtube.com/embed/${_}`,title:"Trailer",frameBorder:"0",allowFullScreen:!0})]})}),N.jsx("h2",{className:"trending-heading",children:"Trending Movies"}),N.jsx("div",{className:"trending-container",children:n.map(v=>N.jsx("div",{className:"trending-card",children:N.jsx(ct,{to:`/movie/${v.id}`,children:N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${v.poster_path}`,alt:v.title,className:"trending-image"})})},v.id))}),N.jsx("h2",{className:"trending-heading",children:"Popular Movies"}),N.jsx("div",{className:"trending-container",children:i.map(v=>N.jsx("div",{className:"trending-card",children:N.jsx(ct,{to:`/movie/${v.id}`,children:N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${v.poster_path}`,alt:v.title,className:"trending-image"})})},v.id))}),N.jsx("h2",{className:"trending-heading",children:"Top Rated Movies"}),N.jsx("div",{className:"trending-container",children:o.map(v=>N.jsx("div",{className:"trending-card",children:N.jsx(ct,{to:`/movie/${v.id}`,children:N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${v.poster_path}`,alt:v.title,className:"trending-image"})})},v.id))}),N.jsx("h2",{className:"trending-heading",children:"Upcoming Movies"}),N.jsx("div",{className:"trending-container",children:u.map(v=>N.jsx("div",{className:"trending-card",children:N.jsx(ct,{to:`/movie/${v.id}`,children:N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${v.poster_path}`,alt:v.title,className:"trending-image"})})},v.id))}),N.jsx(Rs,{})]})},qv="https://api.themoviedb.org/3",Hv="a0ac84614536cd4679d457482617fd23",IL="https://image.tmdb.org/t/p/w200",SL=()=>{const[t,e]=V.useState(""),[n,r]=V.useState([]),[i,s]=V.useState(null),[o,l]=V.useState(!1),[u,c]=V.useState(null),d=async()=>{l(!0),s(null);try{const w=await fetch(`${qv}/trending/movie/day?api_key=${Hv}`);if(!w.ok)throw new Error("Failed to fetch trending movies");const E=await w.json();r(E.results||[])}catch(w){s(w.message)}finally{l(!1)}},p=async w=>{if(!w.trim()){d();return}l(!0),s(null);try{const E=await fetch(`${qv}/search/movie?api_key=${Hv}&query=${encodeURIComponent(w)}`);if(!E.ok)throw new Error("Failed to fetch search results");const C=await E.json();r(C.results||[])}catch(E){s(E.message)}finally{l(!1)}},m=w=>{const E=w.target.value;e(E),u&&clearTimeout(u);const C=setTimeout(()=>{p(E)},500);c(C)};return V.useEffect(()=>{d()},[]),N.jsxs("div",{className:"search-page",children:[N.jsx(Rs,{})," ",N.jsxs("div",{className:"search-container",children:[N.jsx("input",{type:"text",value:t,onChange:m,placeholder:"Search for a movie...",className:"search-input"}),N.jsxs("div",{className:"results-container",children:[o&&N.jsx("p",{children:"Loading..."}),i&&N.jsx("p",{className:"error-message",children:i}),!o&&n.length>0&&n.map(w=>N.jsx(ct,{to:`/movie/${w.id}`,children:N.jsx("img",{src:w.poster_path?`${IL}${w.poster_path}`:"/placeholder.png",alt:w.title||"No Title",className:"result-poster"})},w.id)),!o&&t&&n.length===0&&!i&&N.jsxs("p",{children:['No results found for "',t,'"']})]})]})]})},RL=()=>{const[t,e]=V.useState(""),[n,r]=V.useState(""),[i,s]=V.useState([]),[o,l]=V.useState(!0),[u,c]=V.useState(null),d=gs();V.useEffect(()=>{const E=Go().currentUser;if(E){e(E.email);const C=E.metadata.creationTime,P={year:"numeric",month:"long",day:"numeric"},T=new Date(C).toLocaleDateString("en-GB",P);r(T),(async()=>{const S=nc(),D=Np(S,"users",E.uid),M=await Vp(D);M.exists()?s(M.data().movieList):s([]),l(!1)})()}},[]);const p=async()=>{try{const w=Go();await cb(w),d("/")}catch{c("Failed to log out. Please try again later.")}},m=()=>{alert("Settings button clicked!")};return N.jsxs("div",{className:"profile-page",children:[N.jsx(Rs,{}),"  ",N.jsxs("div",{className:"profile-content",children:[N.jsxs("div",{className:"profile-details",children:[N.jsx("h2",{children:t})," ",N.jsxs("p",{className:"member-since",children:["Member since: ",n]}),N.jsxs("div",{className:"profile-buttons",children:[N.jsx("button",{className:"profile-button",onClick:p,children:"Log Out"}),N.jsx("button",{className:"profile-button",onClick:m,children:"Settings"})]})]}),N.jsxs("div",{className:"movie-list-section",children:[N.jsx("h3",{children:"Your Movie List"}),o?N.jsx("p",{children:"Loading your movie list..."}):u?N.jsxs("p",{children:["Error loading movie list: ",u]}):i.length===0?N.jsx("p",{children:"No movies added yet."}):N.jsx("div",{className:"movie-list",children:i.map((w,E)=>N.jsxs(ct,{to:`/movie/${w.id}`,className:"movie-card-link",children:[" ",N.jsxs("div",{className:"movie-item",children:[N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${w.poster_path}`,alt:w.title,className:"movie-poster"}),N.jsxs("div",{className:"movie-info",children:[N.jsx("h4",{children:w.title}),N.jsx("p",{children:w.release_date}),N.jsx("p",{children:w.imdb_rating?`${w.imdb_rating.toFixed(1)}/10`:"N/A"})]})]})]},E))})]})]})]})},tl="https://api.themoviedb.org/3",nl="a0ac84614536cd4679d457482617fd23";function AL(){const{id:t}=Xf(),e=gs(),[n,r]=V.useState(null),[i,s]=V.useState(!0),[o,l]=V.useState(null),[u,c]=V.useState([]),[d,p]=V.useState([]),[m,w]=V.useState(!1),[E,C]=V.useState(window.innerWidth),[P,T]=V.useState(null),[_,S]=V.useState(!1),D=300;if(V.useEffect(()=>{window.scrollTo(0,0),(async()=>{try{const pt=await ue.get(`${tl}/movie/${t}`,{params:{api_key:nl,language:"en-US"}});r(pt.data);const $=await ue.get(`${tl}/movie/${t}/credits`,{params:{api_key:nl}});c($.data.cast);const G=await ue.get(`${tl}/movie/${t}/similar`,{params:{api_key:nl,language:"en-US"}});p(G.data.results);const me=(await ue.get(`${tl}/movie/${t}/videos`,{params:{api_key:nl,language:"en-US"}})).data.results.find(he=>he.type==="Trailer");T(me?me.key:null),s(!1)}catch{l("Failed to load movie details"),s(!1)}})()},[t]),V.useEffect(()=>{const fe=()=>C(window.innerWidth);return window.addEventListener("resize",fe),()=>window.removeEventListener("resize",fe)},[]),i)return N.jsx("p",{children:"Loading movie details..."});if(o)return N.jsx("p",{children:o});const M=n.release_date?new Date(n.release_date).getFullYear():"N/A",j=n.adult?"18+":"PG-13",I=n.runtime,y=Math.floor(I/60),v=I%60,R=I?`${y}h ${v}m`:"N/A",k=()=>w(!m),x=()=>S(!_),A=E>720?5:3,se=E>720?7:4,gn=async()=>{const fe=Go().currentUser;if(!fe){console.log("User is not authenticated");return}const pt=nc(),$=Np(pt,"users",fe.uid);if(!(await Vp($)).exists())try{await CT($,{name:fe.displayName,email:fe.email,movieList:[]}),console.log("User document created")}catch(J){console.error("Error creating user document: ",J);return}try{await PT($,{movieList:NT({id:n.id,title:n.title,poster_path:n.poster_path,release_date:n.release_date,imdb_rating:n.vote_average,overview:n.overview})}),console.log("Movie added to list")}catch(J){console.error("Error adding movie to list: ",J)}};return N.jsxs("div",{className:"details-page",children:[N.jsx(Rs,{}),N.jsx("div",{className:"details-background",style:{backgroundImage:`url(https://image.tmdb.org/t/p/original${n.backdrop_path})`},children:N.jsxs("div",{className:"details-content",children:[N.jsxs("button",{className:"back-button-details",onClick:()=>e(-1),children:[N.jsx("span",{className:"back-icon",children:"←"})," Back"]}),N.jsxs("div",{className:"overlay",children:[N.jsxs("div",{className:"poster-title-section",children:[N.jsxs("div",{className:"poster-rating-section",children:[N.jsx("img",{className:"additional-poster",src:`https://image.tmdb.org/t/p/w200${n.poster_path}`,alt:n.title}),N.jsx("div",{className:"movie-rating-centered",children:N.jsxs("strong",{children:[n.vote_average.toFixed(1)," / 10"]})})]}),N.jsxs("div",{className:"text-section",children:[N.jsx("h1",{className:"movie-title",children:n.title}),N.jsxs("p",{className:"movie-info",children:[M," · ",j," · ",R]}),N.jsxs("p",{className:"movie-description",children:[m||n.overview.length<=D?n.overview:`${n.overview.slice(0,D)}... `,n.overview.length>D&&N.jsx("button",{onClick:k,className:"read-more-button",children:m?"Show Less":"Read More"})]})]})]}),N.jsxs("div",{className:"cast-section",children:[N.jsxs("div",{className:"cast-header",children:[N.jsx("h2",{children:"Cast"}),N.jsx(ct,{to:`/movie/${t}/cast`,className:"show-all-button",children:"Show All"})]}),N.jsx("div",{className:"cast-list",children:u.slice(0,se).map(fe=>N.jsx("div",{className:"cast-member",children:N.jsxs(ct,{to:`/actor/${fe.id}`,children:[N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${fe.profile_path}`,alt:fe.name,className:"cast-member-photo"}),N.jsx("p",{className:"cast-member-name",children:fe.name})]})},fe.id))}),N.jsxs("div",{className:"button-section",children:[P&&N.jsx("button",{className:"red-button",onClick:x,children:"Watch Trailer"}),N.jsx("button",{className:"red-button",onClick:gn,children:"Add to List"})]})]}),N.jsxs("div",{className:"similar-movies-section",children:[N.jsx("h2",{children:"Similar Movies"}),N.jsx("div",{className:"similar-movies-list",children:d.slice(0,A).map(fe=>N.jsx(ct,{to:`/movie/${fe.id}`,className:"similar-movie",children:N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${fe.poster_path}`,alt:fe.title,className:"similar-movie-poster"})},fe.id))})]})]})]})}),_&&N.jsx("div",{className:"trailer-modal",onClick:x,children:N.jsxs("div",{className:"modal-content",onClick:fe=>fe.stopPropagation(),children:[N.jsx("button",{className:"close-btn",onClick:x,children:"X"}),P?N.jsx("iframe",{width:"100%",height:"400px",src:`https://www.youtube.com/embed/${P}`,title:"Trailer",frameBorder:"0",allowFullScreen:!0}):N.jsx("p",{children:"No trailer available"})]})})]})}const CL="https://api.themoviedb.org/3",PL="a0ac84614536cd4679d457482617fd23",kL=()=>{const{id:t}=Xf(),[e,n]=V.useState([]),[r,i]=V.useState(!0),[s,o]=V.useState(null),l=gs();return V.useEffect(()=>{window.scrollTo(0,0),(async()=>{try{const c=await ue.get(`${CL}/movie/${t}/credits`,{params:{api_key:PL}});n(c.data.cast),i(!1)}catch{o("Failed to load cast details. Please try again."),i(!1)}})()},[t]),r?N.jsx("div",{className:"loading-spinner",children:"Loading..."}):s?N.jsxs("div",{className:"error-container",children:[N.jsx("p",{children:s}),N.jsx("button",{onClick:()=>window.location.reload(),className:"retry-button",children:"Retry"})]}):N.jsxs("div",{className:"full-cast-page",children:[N.jsxs("div",{className:"full-cast-header",children:[N.jsxs("button",{onClick:()=>l(-1),className:"back-button-fullCast",children:[N.jsx("span",{className:"back-icon",children:"←"})," Back"]}),N.jsx("h1",{className:"full-cast-title",children:"Full Cast"})]}),N.jsx("div",{className:"full-cast-list",children:e.map(u=>N.jsx(ct,{to:`/actor/${u.id}`,className:"full-cast-actor-link",children:N.jsxs("div",{className:"full-cast-actor",children:[N.jsx("img",{src:u.profile_path?`https://image.tmdb.org/t/p/w200${u.profile_path}`:"/path/to/placeholder-image.jpg",alt:u.name,className:"full-cast-actor-photo"}),N.jsxs("div",{className:"full-cast-actor-info",children:[N.jsx("p",{className:"full-cast-actor-name",children:u.name}),u.character&&N.jsxs("p",{className:"full-cast-actor-role",children:["as ",u.character]})]})]})},u.id))}),N.jsx(Rs,{})]})},Wv="https://api.themoviedb.org/3",Kv="a0ac84614536cd4679d457482617fd23";function NL(){const t=gs(),{actorId:e}=Xf(),[n,r]=V.useState(null),[i,s]=V.useState([]),[o,l]=V.useState(!0),[u,c]=V.useState(null),[d,p]=V.useState(!1),[m,w]=V.useState(!1),[E,C]=V.useState(6),P=300;V.useEffect(()=>{(async()=>{try{const M=await ue.get(`${Wv}/person/${e}`,{params:{api_key:Kv,language:"en-US"}});r(M.data);const j=await ue.get(`${Wv}/person/${e}/movie_credits`,{params:{api_key:Kv,language:"en-US"}});s(j.data.cast),l(!1)}catch{c("Failed to load actor details"),l(!1)}})()},[e]),V.useEffect(()=>{const D=()=>{const M=window.innerWidth;M>=1070?C(6):M>=900?C(5):M>=740?C(4):(M>=580,C(3))};return D(),window.addEventListener("resize",D),()=>window.removeEventListener("resize",D)},[]);const T=()=>p(!d),_=()=>w(!m);if(o)return N.jsx("p",{children:"Loading actor details..."});if(u)return N.jsx("p",{children:u});const S=m?i:i.slice(0,E);return N.jsxs("div",{className:"actor-detail",children:[N.jsxs("div",{className:"actor-content",children:[N.jsxs("div",{className:"actor-header",children:[N.jsxs("button",{onClick:()=>t(-1),className:"back-button",children:[N.jsx("span",{className:"back-icon",children:"←"})," Back"]}),N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${n.profile_path}`,alt:n.name,className:"actor-photo"}),N.jsxs("div",{className:"actor-info",children:[N.jsx("h1",{children:n.name}),N.jsxs("p",{className:"actor-bio",children:[d||!n.biography||n.biography.length<=P?n.biography:`${n.biography.slice(0,P)}...`,n.biography&&n.biography.length>P&&N.jsx("button",{onClick:T,className:"read-more-button",children:d?"Show Less":"Read More"})]})]})]}),N.jsxs("div",{className:"actor-films",children:[N.jsxs("div",{className:"actor-films-header",children:[N.jsx("h2",{children:"Known For"}),N.jsx("button",{onClick:_,className:"show-all-button",children:m?"Show Less":"Show All"})]}),N.jsx("div",{className:"films-list",children:S.map(D=>N.jsx("div",{className:"film-item",children:N.jsx(ct,{to:`/movie/${D.id}`,children:N.jsx("img",{src:`https://image.tmdb.org/t/p/w200${D.poster_path}`,alt:D.title,className:"film-poster"})})},D.id))})]})]}),N.jsx(Rs,{})]})}var xL="firebase",OL="11.0.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */jt(xL,OL,"app");const dI="@firebase/installations",Wp="0.6.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I2(t){if(!t.startsWith(Jp)){const e=Ot.create("invalid-gtag-resource",{gtagURL:t});return St.warn(e.message),""}return t}function NI(t){return Promise.all(t.map(e=>e.catch(n=>n)))}function S2(t,e){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(t,e)),n}function R2(t,e){const n=S2("firebase-js-sdk-policy",{createScriptURL:I2}),r=document.createElement("script"),i=`${Jp}?l=${t}&id=${e}`;r.src=n?n==null?void 0:n.createScriptURL(i):i,r.async=!0,document.head.appendChild(r)}function A2(t){let e=[];return Array.isArray(window[t])?e=window[t]:window[t]=e,e}async function C2(t,e,n,r,i,s){const o=r[i];try{if(o)await e[o];else{const u=(await NI(n)).find(c=>c.measurementId===i);u&&await e[u.appId]}}catch(l){St.error(l)}t("config",i,s)}async function P2(t,e,n,r,i){try{let s=[];if(i&&i.send_to){let o=i.send_to;Array.isArray(o)||(o=[o]);const l=await NI(n);for(const u of o){const c=l.find(p=>p.measurementId===u),d=c&&e[c.appId];if(d)s.push(d);else{s=[];break}}}s.length===0&&(s=Object.values(e)),await Promise.all(s),t("event",r,i||{})}catch(s){St.error(s)}}function k2(t,e,n,r){async function i(s,...o){try{if(s==="event"){const[l,u]=o;await P2(t,e,n,l,u)}else if(s==="config"){const[l,u]=o;await C2(t,e,n,r,l,u)}else if(s==="consent"){const[l,u]=o;t("consent",l,u)}else if(s==="get"){const[l,u,c]=o;t("get",l,u,c)}else if(s==="set"){const[l]=o;t("set",l)}else t(s,...o)}catch(l){St.error(l)}}return i}function N2(t,e,n,r,i){let s=function(...o){window[r].push(arguments)};return window[i]&&typeof window[i]=="function"&&(s=window[i]),window[i]=k2(s,t,e,n),{gtagCore:s,wrappedGtag:window[i]}}function x2(t){const e=window.document.getElementsByTagName("script");for(const n of Object.values(e))if(n.src&&n.src.includes(Jp)&&n.src.includes(t))return n;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O2=30,D2=1e3;class b2{constructor(e={},n=D2){this.throttleMetadata=e,this.intervalMillis=n}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,n){this.throttleMetadata[e]=n}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const xI=new b2;function L2(t){return new Headers({Accept:"application/json","x-goog-api-key":t})}async function V2(t){var e;const{appId:n,apiKey:r}=t,i={method:"GET",headers:L2(r)},s=E2.replace("{app-id}",n),o=await fetch(s,i);if(o.status!==200&&o.status!==304){let l="";try{const u=await o.json();!((e=u.error)===null||e===void 0)&&e.message&&(l=u.error.message)}catch{}throw Ot.create("config-fetch-failed",{httpStatus:o.status,responseMessage:l})}return o.json()}async function M2(t,e=xI,n){const{appId:r,apiKey:i,measurementId:s}=t.options;if(!r)throw Ot.create("no-app-id");if(!i){if(s)return{measurementId:s,appId:r};throw Ot.create("no-api-key")}const o=e.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},l=new j2;return setTimeout(async()=>{l.abort()},w2),OI({appId:r,apiKey:i,measurementId:s},o,l,e)}async function OI(t,{throttleEndTimeMillis:e,backoffCount:n},r,i=xI){var s;const{appId:o,measurementId:l}=t;try{await F2(r,e)}catch(u){if(l)return St.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${l} provided in the "measurementId" field in the local Firebase config. [${u==null?void 0:u.message}]`),{appId:o,measurementId:l};throw u}try{const u=await V2(t);return i.deleteThrottleMetadata(o),u}catch(u){const c=u;if(!U2(c)){if(i.deleteThrottleMetadata(o),l)return St.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${l} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:o,measurementId:l};throw u}const d=Number((s=c==null?void 0:c.customData)===null||s===void 0?void 0:s.httpStatus)===503?Oy(n,i.intervalMillis,O2):Oy(n,i.intervalMillis),p={throttleEndTimeMillis:Date.now()+d,backoffCount:n+1};return i.setThrottleMetadata(o,p),St.debug(`Calling attemptFetch again in ${d} millis`),OI(t,p,r,i)}}function F2(t,e){return new Promise((n,r)=>{const i=Math.max(e-Date.now(),0),s=setTimeout(n,i);t.addEventListener(()=>{clearTimeout(s),r(Ot.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function U2(t){if(!(t instanceof en)||!t.customData)return!1;const e=Number(t.customData.httpStatus);return e===429||e===500||e===503||e===504}class j2{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function B2(t,e,n,r,i){if(i&&i.global){t("event",n,r);return}else{const s=await e,o=Object.assign(Object.assign({},r),{send_to:s});t("event",n,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function z2(){if(nE())try{await rE()}catch(t){return St.warn(Ot.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return St.warn(Ot.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function $2(t,e,n,r,i,s,o){var l;const u=M2(t);u.then(w=>{n[w.measurementId]=w.appId,t.options.measurementId&&w.measurementId!==t.options.measurementId&&St.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${w.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(w=>St.error(w)),e.push(u);const c=z2().then(w=>{if(w)return r.getId()}),[d,p]=await Promise.all([u,c]);x2(s)||R2(s,d.measurementId),i("js",new Date);const m=(l=o==null?void 0:o.config)!==null&&l!==void 0?l:{};return m[_2]="firebase",m.update=!0,p!=null&&(m[v2]=p),i("config",d.measurementId,m),d.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q2{constructor(e){this.app=e}_delete(){return delete vo[this.app.options.appId],Promise.resolve()}}let vo={},Jv=[];const Yv={};let Rh="dataLayer",H2="gtag",Xv,DI,Zv=!1;function W2(){const t=[];if(tE()&&t.push("This is a browser extension environment."),OP()||t.push("Cookies are not available."),t.length>0){const e=t.map((r,i)=>`(${i+1}) ${r}`).join(" "),n=Ot.create("invalid-analytics-context",{errorInfo:e});St.warn(n.message)}}function K2(t,e,n){W2();const r=t.options.appId;if(!r)throw Ot.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)St.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Ot.create("no-api-key");if(vo[r]!=null)throw Ot.create("already-exists",{id:r});if(!Zv){A2(Rh);const{wrappedGtag:s,gtagCore:o}=N2(vo,Jv,Yv,Rh,H2);DI=s,Xv=o,Zv=!0}return vo[r]=$2(t,Jv,Yv,e,Xv,Rh,n),new q2(t)}function G2(t=sp()){t=ze(t);const e=fi(t,vu);return e.isInitialized()?e.getImmediate():Q2(t)}function Q2(t,e={}){const n=fi(t,vu);if(n.isInitialized()){const i=n.getImmediate();if(is(e,n.getOptions()))return i;throw Ot.create("already-initialized")}return n.initialize({options:e})}function J2(t,e,n,r){t=ze(t),B2(DI,vo[t.app.options.appId],e,n,r).catch(i=>St.error(i))}const e_="@firebase/analytics",t_="0.10.10";function Y2(){fn(new Yt(vu,(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return K2(r,i,n)},"PUBLIC")),fn(new Yt("analytics-internal",t,"PRIVATE")),jt(e_,t_),jt(e_,t_,"esm2017");function t(e){try{const n=e.getProvider(vu).getImmediate();return{logEvent:(r,i,s)=>J2(n,r,i,s)}}catch(n){throw Ot.create("interop-component-reg-failed",{reason:n})}}}Y2();const X2={apiKey:"AIzaSyB-PI0ZJCrWuIkTr7RVSofJdgcXBR21r18",authDomain:"filmfanatic-7d265.firebaseapp.com",projectId:"filmfanatic-7d265",storageBucket:"filmfanatic-7d265.firebasestorage.app",messagingSenderId:"1031117293329",appId:"1:1031117293329:web:1e7633dc533e44a15deeb0",measurementId:"G-FF32LYE65B"},Yp=aE(X2),Ah=Go(Yp);nc(Yp);G2(Yp);const Z2=()=>{const[t,e]=V.useState(""),[n,r]=V.useState(""),[i,s]=V.useState(""),[o,l]=V.useState(!1),[u,c]=V.useState(!1),d=gs(),p=E=>e(E.target.value),m=E=>r(E.target.value);V.useEffect(()=>{const E=Ah.onAuthStateChanged(C=>{C&&d("/home")});return()=>E()},[d]);const w=async E=>{if(E.preventDefault(),!t||!n){s("Please enter both email and password.");return}l(!0),s("");try{u?(await sb(Ah,t,n),l(!1),d("/home")):(await ob(Ah,t,n),l(!1),d("/home"))}catch(C){l(!1),s(C.message)}};return N.jsx("div",{className:"login-page",children:N.jsxs("form",{onSubmit:w,className:"login-form",children:[N.jsxs("div",{className:"form-group",children:[N.jsx("label",{htmlFor:"email",children:"Email:"}),N.jsx("input",{type:"email",id:"email",value:t,onChange:p,placeholder:"Enter your email",required:!0})]}),N.jsxs("div",{className:"form-group",children:[N.jsx("label",{htmlFor:"password",children:"Password:"}),N.jsx("input",{type:"password",id:"password",value:n,onChange:m,placeholder:"Enter your password",required:!0})]}),i&&N.jsx("p",{className:"error-message",children:i}),N.jsx("button",{type:"submit",className:"login-button",disabled:o,children:o?u?"Registering...":"Logging in...":u?"Register":"Login"}),N.jsxs("div",{className:"register-option",children:[N.jsx("p",{children:"or"}),N.jsx("button",{type:"button",className:"register-button",onClick:()=>c(E=>!E),children:u?"Already have an account? Login":"Need an account? Register"})]})]})})},eV=()=>N.jsx(MA,{children:N.jsxs(NA,{children:[N.jsx(Kn,{path:"/",element:N.jsx(Z2,{})}),"  ",N.jsx(Kn,{path:"/home",element:N.jsx(TL,{})}),N.jsx(Kn,{path:"/search",element:N.jsx(SL,{})}),N.jsx(Kn,{path:"/profile",element:N.jsx(RL,{})}),N.jsx(Kn,{path:"/movie/:id",element:N.jsx(AL,{})}),N.jsx(Kn,{path:"/movie/:id/cast",element:N.jsx(kL,{})}),N.jsx(Kn,{path:"/actor/:actorId",element:N.jsx(NL,{})})]})});pw(document.getElementById("root")).render(N.jsx(V.StrictMode,{children:N.jsx(eV,{})}));
